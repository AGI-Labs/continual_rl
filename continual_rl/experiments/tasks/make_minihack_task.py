...
def make_minihack(
    ...
    **kwargs,
    ...
    observation_keys=["glyphs", "chars", "colors", "specials", "blstats", "message", "tty_chars", "tty_colors", "internal", "inv_oclasses", "inv_glyphs"] #, "pixel_crop"],  Pixel crop not available much to my infinite displeasure
