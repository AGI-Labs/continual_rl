...
class ImageTask(TaskBase):
    def __init__(self, task_id, env_spec, num_timesteps, time_batch_size, eval_mode, output_dir, image_size, grayscale):
        ...
        super().__init__(task_id, env_spec, obs_size, action_size, time_batch_size, num_timesteps, eval_mode, output_dir)
