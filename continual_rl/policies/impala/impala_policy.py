...
from continual_rl.policies.impala.nets import ImpalaNet, ContinuousImpalaNet, TransporterImpalaNet, PointQueryImpalaNet
...
class ImpalaPolicy(PolicyBase):
    ...
    def __init__(self, config: ImpalaPolicyConfig, observation_space, action_spaces, impala_class: Monobeast = None,
        ...
        if policy_net_class is None:
            if model_flags.point_query_net:
                policy_net_class = PointQueryImpalaNet
            elif model_flags.transporter_net:
