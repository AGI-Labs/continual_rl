...
class PolicyBase(ABC):
    ...
    def compute_action(self, observation, action_space_id, last_info_to_store):
        ...
        :param last_info_to_store: The last info_to_store generated by this policy. Not reset on episode completion.
        (Caller will need to check last_info_to_store.done manually if this is desired.)
