    ...
    "stretch_large_waffle_iron_shift_left_oven_shift": create_continuous_control_tasks_loader(
        ...
        env_specs=[
            lambda: StretchOfflineDemoEnv(
                ...
                demo_dir="/home/spowers/Git/home_robot/src/home_robot/ros/tmp/demo_data/large_waffle_iron_shift_noholes",
                state_augmentation_scale=3, use_key_frames=True, command_absolute=True, camera_info_in_state=True),
            #lambda: StretchOfflineDemoEnv(
            #    demo_dir="/home/spowers/Git/home_robot/src/home_robot/ros/tmp/demo_data/left_oven_key_frames_shift",
            #    state_augmentation_scale=3, use_key_frames=True, command_absolute=True, camera_info_in_state=True),
        ...
        num_timesteps=[4000, 4000, 1e1, 1e1],
        continual_testing_freq=1000,
        use_state=True,
        image_size=[1280, 720],
        cycle_count=1),

    "stretch_large_waffle_iron_separate": create_continuous_control_tasks_loader(
        ["StretchDemo1", "StretchDemo2", "StretchDemo3",  "Live1", "Live2", "Live3"],
        env_specs=[
            lambda: StretchOfflineDemoEnv(
                demo_dir="/home/spowers/Git/home_robot/src/home_robot/ros/tmp/demo_data/large_waffle_iron_shift_separate/0",
                state_augmentation_scale=3, use_key_frames=True, command_absolute=True, camera_info_in_state=True),
            lambda: StretchOfflineDemoEnv(
                demo_dir="/home/spowers/Git/home_robot/src/home_robot/ros/tmp/demo_data/large_waffle_iron_shift_separate/1",
                state_augmentation_scale=3, use_key_frames=True, command_absolute=True, camera_info_in_state=True),
            lambda: StretchOfflineDemoEnv(
                demo_dir="/home/spowers/Git/home_robot/src/home_robot/ros/tmp/demo_data/large_waffle_iron_shift_separate/2",
                state_augmentation_scale=3, use_key_frames=True, command_absolute=True, camera_info_in_state=True),
            lambda: StretchLiveEnv(
                demo_dir="/home/spowers/Git/home_robot/src/home_robot/ros/tmp/demo_data/large_waffle_iron_shift_separate/0",
                use_true_action=False, use_key_frames=True, command_absolute=True, camera_info_in_state=True,
        ...
        #num_timesteps=[3500, 3500, 1e1, 1e1],
        num_timesteps=[5000, 5000, 5000, 1e1, 1e1, 1e1],
        continual_testing_freq=1000,
        use_state=True,
        image_size=[1280, 720],
        cycle_count=1),
