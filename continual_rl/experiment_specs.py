...
def get_available_experiments():
    ...
    experiments = LazyDict({
        ...
        "minigrid_empty8_obstacles5_unlock": create_minigrid_tasks_loader([(0, 'MiniGrid-Empty-8x8-v0', 300000),
                                                                        (1, "MiniGrid-Dynamic-Obstacles-Random-5x5-v0", 750000),
                                                                        (0, 'MiniGrid-Unlock-v0', 1500000)]),
        "minigrid_empty8_obstacles5_unlockpickup": create_minigrid_tasks_loader([(0, 'MiniGrid-Empty-8x8-v0', 300000),
                                                                        (1, "MiniGrid-Dynamic-Obstacles-Random-5x5-v0", 750000),
                                                                        (0, 'MiniGrid-UnlockPickup-v0', 1500000)]),
        "minigrid_empty8_obstacles5_keycorridor": create_minigrid_tasks_loader([(0, 'MiniGrid-Empty-8x8-v0', 300000),
                                                                        (1, "MiniGrid-Dynamic-Obstacles-Random-5x5-v0", 750000),
                                                                        (0, 'MiniGrid-KeyCorridorS3R1-v0', 1500000)]),

        "minigrid_2room_lavagap5_obstacles": create_minigrid_tasks_loader([(0, 'MiniGrid-MultiRoom-N2-S4-v0', 750000),
                                                                        (0, 'MiniGrid-LavaGapS5-v0', 750000),
                                                                        (1, 'MiniGrid-Dynamic-Obstacles-Random-5x5-v0', 750000)]),
        "minigrid_empty_lavagap5_obstacles": create_minigrid_tasks_loader([(0, 'MiniGrid-Empty-8x8-v0', 750000),
                                                                           (0, 'MiniGrid-LavaGapS5-v0', 750000),
        ...
        "minigrid_oddmanout_yelred_6": create_minigrid_tasks_loader([(0, lambda: OddManOutEnv(correct_color='red', incorrect_color='yellow', num_choices=6), 300000),
                                                             (0, lambda: OddManOutEnv(correct_color='yellow', incorrect_color='red', num_choices=6), 750000)]),
        "minigrid_oddmanout_trip": create_minigrid_tasks_loader([(0, lambda: OddManOutEnv(correct_color='red', incorrect_color='yellow'), 300000),
                                                                 (0, lambda: OddManOutEnv(correct_color='green', incorrect_color='red'), 750000),
                                                                 (0, lambda: OddManOutEnv(correct_color='yellow', incorrect_color='green'), 750000)]),
        "minigrid_oddmanout_quad": create_minigrid_tasks_loader([(0, lambda: OddManOutEnv(correct_color='red', incorrect_color='yellow'), 300000),
                                                                 (0, lambda: OddManOutEnv(correct_color='green', incorrect_color='red'), 750000),
        ...
        "minigrid_empty_oddmanout_yelblue_mask": create_minigrid_tasks_loader(
            [(0, 'MiniGrid-Empty-8x8-v0', 300000, True),
             (0, lambda: OddManOutEnv(correct_color='blue', incorrect_color='yellow'), 300000, True),
             (0, lambda: OddManOutEnv(correct_color='yellow', incorrect_color='blue'), 750000, True)]),
