...
def get_available_experiments():
    ...
    experiments = LazyDict({
        ...
        "minigrid_association_2_match_invis1_distract": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
        ...
        "minigrid_association_2_match_invis1_2distract": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 (None, 'grey'),
        ...
        "minigrid_association_2_invis_colorfuldistract": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 (None, 'purple'),
        ...
        "minigrid_association_2_invis_colorfuldistract_squeeze": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 (None, 'purple'),
                                                                 (None, 'green'),
                                                                 (None, 'grey')], indicator_color='red', squeeze_together=True), 1000000, 1, True),  # "invisible" indicator
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'green'),
                                                              ('green', 'purple'),
                                                                 (None, 'blue'),
                                                                 (None, 'yellow'),
                                                                 (None, 'grey')], indicator_color='grey', squeeze_together=True), 1000000, 1, True)
            ]
        ),
        "minigrid_association_2_invis_colorfuldistract_easier": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 (None, 'purple'),
                                                                 (None, 'green')], indicator_color='red'), 1000000, 1, True),  # "invisible" indicator
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'green'),
                                                              ('green', 'purple'),
                                                                 (None, 'blue'),
                                                                 (None, 'yellow')], indicator_color='grey'), 1000000, 1, True)
            ]
        ),
        "minigrid_association_2_invis_colorfuldistract_easier_squeeze": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 (None, 'purple'),
                                                                 (None, 'green')], indicator_color='red', squeeze_together=True),
                 1000000, 1, True),  # "invisible" indicator
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'green'),
                                                              ('green', 'purple'),
                                                                 (None, 'blue'),
                                                                 (None, 'yellow')], indicator_color='grey', squeeze_together=True),
                 1000000, 1, True)
            ]
        ),
        "minigrid_association_2_invis_colorfuldistract_easier_squeeze_2indic": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 (None, 'purple'),
                                                                 (None, 'green')], indicator_color='grey',
                                           num_indicators=1, squeeze_together=True),
                 1000000, 1, True),  # "invisible" indicator
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'green'),
                                                              ('green', 'purple'),
                                                                 (None, 'blue'),
                                                                 (None, 'yellow')], indicator_color='grey',
                                           num_indicators=2, squeeze_together=True),
                 1000000, 1, True)
            ]
        ),
        "minigrid_association_3_invis_colorfuldistract_squeeze": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 ('yellow', 'purple'),
        ...
        "minigrid_association_3_invis_colorfuldistract_squeeze2": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 ('yellow', 'green'),
                                                                 (None, 'purple')], indicator_color='red', squeeze_together=True),
                 1000000, 1, True),  # "invisible" indicator
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'green'),
                                                              ('green', 'purple'),
                                                                 ('yellow', 'blue'),
        ...
        "minigrid_association_4_invis_colorfuldistract_squeeze": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 ('yellow', 'green'),
                                                              ('blue', 'purple')], indicator_color='red', squeeze_together=True),
                 1000000, 1, True),  # "invisible" indicator
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'green'),
                                                              ('green', 'purple'),
                                                                 ('yellow', 'blue'),
                                                                 ('blue', 'yellow')], indicator_color='grey', squeeze_together=True),
                 1000000, 1, True)
            ]
        ),
            ...
            [
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'yellow'),
                                                              ('green', 'blue'),
                                                                 (None, 'grey')], indicator_color='red'), 1000000, 1, True),  # "invisible" indicator
                (0, lambda: AssociationEnv(association_pairs=[('purple', 'blue'),
                                                              ('green', 'yellow')], indicator_color='grey'), 1000000, 1, True)
            ]
        ),
        ...
        "minigrid_association_3_match_rand_4time_mean_distract": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnvRandomSpots(association_pairs=[('blue', 'purple'),
                                                                         ('yellow', 'green'),
                                                                         ('purple', 'yellow'),
        ...
        "minigrid_association_2_match_rand_4time_mean_1distract": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnvRandomSpots(association_pairs=[('blue', 'purple'),
                                                                         ('purple', 'green'),
        ...
        "minigrid_association_2_match_rand_4time_mean_1distract_col2": create_minigrid_tasks_loader(
            [
                (0, lambda: AssociationEnvRandomSpots(association_pairs=[('blue', 'yellow'),
                                                                         ('yellow', 'blue'),
                                                                         (None, 'green')], indicator_color='purple'),
