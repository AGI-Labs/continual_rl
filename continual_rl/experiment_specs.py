...
def get_available_experiments():
    ...
    experiments = LazyDict({
        ...
        "minihack_nav_paired_2_cycles": create_minihack_loader(
            ...
            [
                ("MiniHack-Room-Random-5x5-v0", "MiniHack-Room-Random-15x15-v0"),
                ("MiniHack-Room-Dark-5x5-v0", "MiniHack-Room-Dark-15x15-v0"),
                ("MiniHack-Room-Monster-5x5-v0", "MiniHack-Room-Monster-15x15-v0"),
                ("MiniHack-Room-Trap-5x5-v0", "MiniHack-Room-Trap-15x15-v0"),
                ("MiniHack-Room-Ultimate-5x5-v0", "MiniHack-Room-Ultimate-15x15-v0"),
                ("MiniHack-Corridor-R2-v0", "MiniHack-Corridor-R5-v0"),
                ("MiniHack-Corridor-R3-v0", "MiniHack-Corridor-R5-v0"),
                ("MiniHack-KeyRoom-S5-v0", "MiniHack-KeyRoom-S15-v0"),
                ("MiniHack-KeyRoom-Dark-S5-v0", "MiniHack-KeyRoom-Dark-S15-v0"),
                ("MiniHack-River-Narrow-v0", "MiniHack-River-v0"),
                ("MiniHack-River-Monster-v0", "MiniHack-River-MonsterLava-v0"),
                ("MiniHack-River-Lava-v0", "MiniHack-River-MonsterLava-v0"),
                ("MiniHack-HideNSeek-v0", "MiniHack-HideNSeek-Big-v0"),
        ...
        "nle_challenge_inventory_test": create_minihack_loader("nle_inv_test", [("NetHackInventoryManagement-v0", None)], #"NetHackScore-v0")],
                                                               num_timesteps=[5e7, 5e9], continual_testing_freq=None), #2e6
        "nle_challenge_inventory_pick_and_eat": create_minihack_loader("nle_inv_pick_and_eat", [("NetHackPickAndEat-v0", "NetHackScore-v0")],
            num_timesteps=[5e7, 5e9], continual_testing_freq=2e6),
        "nle_challenge_no_innate": create_minihack_loader("nle_challenge", [("NetHackScoreNoInnateDrive-v0", None)],
        ...
        "nle_challenge_innate100": create_minihack_loader("nle_challenge", [("NetHackScoreInnateDrive100-v0", None)],
            num_timesteps=5e9, continual_testing_freq=None),
        "nle_challenge_innate0.1": create_minihack_loader("nle_challenge", [("NetHackScoreInnateDrive0.1-v0", None)],
            num_timesteps=5e9, continual_testing_freq=None),
        "nle_challenge_innate0.1_depth1.0": create_minihack_loader("nle_challenge", [("NetHackScoreInnateDrive0.1_depth1.0-v0", None)],
            num_timesteps=5e9, continual_testing_freq=None),
        "nle_challenge_innate0.1_time0.1": create_minihack_loader("nle_challenge", [("NetHackScoreInnateDrive0.1_time0.1-v0", None)],
            num_timesteps=5e9, continual_testing_freq=None),
        "nle_challenge": create_minihack_loader("nle_challenge", [("NetHackScore-v0", None)],
            num_timesteps=5e9, continual_testing_freq=None),
        "nle_challenge_eval": create_minihack_loader("nle_challenge", [("NetHackScore-v0", "NetHackScore-v0")],
            num_timesteps=5e9, continual_testing_freq=None),  # num_timesteps not currently used in this case (TODO)
        "nle_challenge_innate0.1_eval": create_minihack_loader("nle_challenge", [("NetHackScoreInnateDrive0.1-v0", "NetHackScore-v0")],
            num_timesteps=5e9, continual_testing_freq=5e6),  # num_timesteps not currently used in this case (TODO)
        "nle_challenge_no_innate_eval": create_minihack_loader("nle_challenge", [("NetHackScoreNoInnateDrive-v0", "NetHackScore-v0")],
            num_timesteps=5e9, continual_testing_freq=5e6),  # num_timesteps not currently used in this case (TODO)
