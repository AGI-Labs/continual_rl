...
def get_available_experiments():
    ...
    experiments = LazyDict({
        ...
        "alfred_demo_based_thor_1000_steps_2": create_alfred_demo_based_thor_loader(num_timesteps=2e6, max_episode_steps=1000, sequence_file_name='alfred_task_sequences_2.json'),
